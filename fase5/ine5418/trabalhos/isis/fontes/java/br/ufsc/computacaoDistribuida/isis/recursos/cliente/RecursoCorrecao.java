...
@Path("/correcao/{identificador}")
public final class RecursoCorrecao {

	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Response postar(@PathParam("identificador") String identificador, JSONObject dados) throws JSONException {
		Servidor.fornecerInstancia().receberMensagem(new Mensagem(identificador, Operacao.CORRIGIR, dados.getDouble("valor")));
