...
@Path("/deposito/{identificador}")
public final class RecursoDeposito {

	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Response postar(@PathParam("identificador") String identificador, JSONObject dados) throws JSONException {
		Servidor.fornecerInstancia().receberMensagem(new Mensagem(identificador, Operacao.DEPOSITAR, dados.getDouble("valor")));
